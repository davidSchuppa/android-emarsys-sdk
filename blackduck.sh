...
--detect.blackduck.signature.scanner.paths=~/work/android/android-emarsys-sdk/ \
...
--detect.source.path=~/work/android/android-emarsys-sdk/  \
--detect.latest.release.version=6.7.0 \
--detect.npm.include.dev.dependencies=false \
--detect.sbt.report.search.depth=4 \
--detect.gradle.path=~/work/android/android-emarsys-sdk/gradlew
